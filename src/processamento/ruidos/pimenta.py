...
def ruido_pimenta(imagem, densidade=0.05):
    """
    Adiciona ruído pimenta (pixels pretos) à imagem
    ...
    # Aplicar pimenta (preto = 0)
    if c == 1:
        resultado[coords_y, coords_x] = 0
    else:
        resultado[coords_y, coords_x] = [0, 0, 0]
